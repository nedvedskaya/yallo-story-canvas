...
export const FORMAT_TEXT_DEFAULTS: Record<SlideFormat, { titleSize: number; bodySize: number; padding: number; usernameSize: number; footerSize: number }> = {
  carousel:     { titleSize: 68, bodySize: 38, padding: 76, usernameSize: 24, footerSize: 22 },
  square:       { titleSize: 60, bodySize: 34, padding: 64, usernameSize: 22, footerSize: 20 },
  stories:      { titleSize: 78, bodySize: 44, padding: 90, usernameSize: 24, footerSize: 22 },
  presentation: { titleSize: 60, bodySize: 30, padding: 70, usernameSize: 20, footerSize: 18 },
};
